...
@fragment
fn fs(input: ThicknessMapFragmentInput) -> @location(0) vec4f {
    ...
    // Slightly improved alpha blending for better depth perception
    let particle_alpha = 0.06; // Increased from 0.05 for better visibility
